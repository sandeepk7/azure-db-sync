...
export class ValuePreprocessor implements ast.AstVisitor {
  ...
  visitBinary(node: ast.Binary) { throw new Error('Method not implemented.'); }
  ...
  visitPropertyWrite(node: ast.PropertyWrite) { throw new Error('Method not implemented.'); }
  visitQuote(node: ast.Quote) { throw new Error('Method not implemented.'); }
  visitSafeMethodCall(node: ast.SafeMethodCall) { throw new Error('Method not implemented.'); }
  visitSafePropertyRead(node: ast.SafePropertyRead) { throw new Error('Method not implemented.'); }
}
