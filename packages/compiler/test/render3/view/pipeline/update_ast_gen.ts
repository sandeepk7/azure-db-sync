...
import {createStyleProp, createStyleMap} from '../../../../src/render3/view/pipeline/style';
import {createClassProp, createClassMap} from '../../../../src/render3/view/pipeline/class';
...
export abstract class UpdateAstGenBase {
  ...
  build(): uir.Node[] { return this._list.toArray(); }
}
